...
/**
 * Get the prekey element for the current node in the key list.
 *
 * @param node current list node
 * @return prekey element
 */
 ...
 *
 * @param signed_pre_key set to the generated prekey
 * @param identity_key_pair the local client's identity key pair.
 * @param signed_pre_key_id the prekey ID to assign the generated signed prekey
