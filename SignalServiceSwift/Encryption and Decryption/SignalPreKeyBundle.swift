...
private func checkValidity(of bundle: UnsafeMutablePointer<session_pre_key_bundle>) -> Bool {
...
public class SignalPreKeyBundle: NSObject {
    ...
    public init?(registrationId: UInt32, deviceId: Int32, preKeyId: UInt32, preKeyPublic: Data, signedPreKeyId: UInt32, signedPreKeyPublic
        ...
        var bundlePointer: UnsafeMutablePointer<session_pre_key_bundle>?
    ...
    deinit {
        session_pre_key_bundle_destroy(UnsafeMutableRawPointer(self.bundle).assumingMemoryBound(to: signal_type_base.self))
    }
